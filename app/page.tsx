...
const mockProducts = [
    { nome: "Bronzer", preco: "R$ 254,99", imageurl: "/images/product_bronzer.png" },
    { nome: "Blush", preco: "R$ 199,99", imageurl: "/images/product_blush.png" },
    { nome: "Perfume Rare", preco: "R$ 599,90", imageurl: "/images/product_perfume.png" },
    { nome: "Iluminador", preco: "R$ 249,90", imageurl: "/images/product_iluminador.png" },
    { nome: "Mini Blush", preco: "R$ 99,99", imageurl: "/images/product_mini.png" },
];
  ...
  return (
    <div className="min-h-screen bg-stone-50"> 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end -mt-24"> 
            ...
            <div className="flex items-center space-x-6">
              ...
              {/* Texto do Perfil */}
              <div className="mt-8"> 
                <h1 className="text-3xl font-bold text-gray-900">{mockUserData.name}</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        ...
        {/* Grade de Produtos (Mapeando os mocks) */}
